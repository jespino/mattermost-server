...
const (
	...
	WEBSOCKET_NUMBER_OF_REGISTERED_USERS_METRIC_STATUS = "number_of_registered_users_metric_status"
	WEBSOCKET_NUMBER_OF_POSTS_METRIC_STATUS            = "number_of_posts_metric_status"
)

...
const (
	...
	SYSTEM_NUMBER_OF_REGISTERED_USERS_METRIC = "NumberOfRegisteredUsersMetric"
	SYSTEM_NUMBER_OF_POSTS_METRIC            = "NumberOfPostsMetric"
)

const NUMBER_OF_ACTIVE_USERS_METRIC_LIMIT = 100
const NUMBER_OF_REGISTERED_USERS_METRIC_LIMIT = 250
const NUMBER_OF_POSTS_METRIC_LIMIT = 200000

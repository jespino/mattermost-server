...
func NewSqlStore(settings model.SqlSettings, metrics einterfaces.MetricsInterface) *SqlStore {
	...
	sqlStore.stores.team = NewSqlTeamStore(sqlStore, metrics)
	sqlStore.stores.channel = NewSqlChannelStore(sqlStore, metrics)
	sqlStore.stores.post = NewSqlPostStore(sqlStore, metrics)
	sqlStore.stores.user = NewSqlUserStore(sqlStore, metrics)
	sqlStore.stores.bot = NewSqlBotStore(sqlStore, metrics)
	sqlStore.stores.audit = NewSqlAuditStore(sqlStore)
	sqlStore.stores.cluster = NewSqlClusterDiscoveryStore(sqlStore)
	sqlStore.stores.compliance = NewSqlComplianceStore(sqlStore)
	sqlStore.stores.session = NewSqlSessionStore(sqlStore)
	sqlStore.stores.oauth = NewSqlOAuthStore(sqlStore)
	sqlStore.stores.system = NewSqlSystemStore(sqlStore)
	sqlStore.stores.webhook = NewSqlWebhookStore(sqlStore, metrics)
	sqlStore.stores.command = NewSqlCommandStore(sqlStore)
	sqlStore.stores.commandWebhook = NewSqlCommandWebhookStore(sqlStore)
	sqlStore.stores.preference = NewSqlPreferenceStore(sqlStore)
	sqlStore.stores.license = NewSqlLicenseStore(sqlStore)
	sqlStore.stores.token = NewSqlTokenStore(sqlStore)
	sqlStore.stores.emoji = NewSqlEmojiStore(sqlStore, metrics)
	sqlStore.stores.status = NewSqlStatusStore(sqlStore)
	sqlStore.stores.fileInfo = NewSqlFileInfoStore(sqlStore, metrics)
	sqlStore.stores.job = NewSqlJobStore(sqlStore)
	sqlStore.stores.userAccessToken = NewSqlUserAccessTokenStore(sqlStore)
	sqlStore.stores.channelMemberHistory = NewSqlChannelMemberHistoryStore(sqlStore)
	sqlStore.stores.plugin = NewSqlPluginStore(sqlStore)
	sqlStore.stores.TermsOfService = NewSqlTermsOfServiceStore(sqlStore, metrics)
	sqlStore.stores.UserTermsOfService = NewSqlUserTermsOfServiceStore(sqlStore)
	sqlStore.stores.linkMetadata = NewSqlLinkMetadataStore(sqlStore)
	sqlStore.stores.reaction = NewSqlReactionStore(sqlStore)
	sqlStore.stores.role = NewSqlRoleStore(sqlStore)
	sqlStore.stores.scheme = NewSqlSchemeStore(sqlStore)
	sqlStore.stores.group = NewSqlGroupStore(sqlStore)
	...
	sqlStore.stores.team.(*SqlTeamStore).CreateIndexesIfNotExists()
	sqlStore.stores.channel.(*SqlChannelStore).CreateIndexesIfNotExists()
	sqlStore.stores.post.(*SqlPostStore).CreateIndexesIfNotExists()
	sqlStore.stores.user.(*SqlUserStore).CreateIndexesIfNotExists()
	sqlStore.stores.bot.(*SqlBotStore).CreateIndexesIfNotExists()
	sqlStore.stores.audit.(*SqlAuditStore).CreateIndexesIfNotExists()
	sqlStore.stores.compliance.(*SqlComplianceStore).CreateIndexesIfNotExists()
	sqlStore.stores.session.(*SqlSessionStore).CreateIndexesIfNotExists()
	sqlStore.stores.oauth.(*SqlOAuthStore).CreateIndexesIfNotExists()
	sqlStore.stores.system.(*SqlSystemStore).CreateIndexesIfNotExists()
	sqlStore.stores.webhook.(*SqlWebhookStore).CreateIndexesIfNotExists()
	sqlStore.stores.command.(*SqlCommandStore).CreateIndexesIfNotExists()
	sqlStore.stores.commandWebhook.(*SqlCommandWebhookStore).CreateIndexesIfNotExists()
	sqlStore.stores.preference.(*SqlPreferenceStore).CreateIndexesIfNotExists()
	sqlStore.stores.license.(*SqlLicenseStore).CreateIndexesIfNotExists()
	sqlStore.stores.token.(*SqlTokenStore).CreateIndexesIfNotExists()
	sqlStore.stores.emoji.(*SqlEmojiStore).CreateIndexesIfNotExists()
	sqlStore.stores.status.(*SqlStatusStore).CreateIndexesIfNotExists()
	sqlStore.stores.fileInfo.(*SqlFileInfoStore).CreateIndexesIfNotExists()
	sqlStore.stores.job.(*SqlJobStore).CreateIndexesIfNotExists()
	sqlStore.stores.userAccessToken.(*SqlUserAccessTokenStore).CreateIndexesIfNotExists()
	sqlStore.stores.plugin.(*SqlPluginStore).CreateIndexesIfNotExists()
	sqlStore.stores.TermsOfService.(SqlTermsOfServiceStore).CreateIndexesIfNotExists()
	sqlStore.stores.UserTermsOfService.(SqlUserTermsOfServiceStore).CreateIndexesIfNotExists()
	sqlStore.stores.linkMetadata.(*SqlLinkMetadataStore).CreateIndexesIfNotExists()
	sqlStore.stores.group.(*SqlGroupStore).CreateIndexesIfNotExists()
	sqlStore.stores.preference.(*SqlPreferenceStore).DeleteUnusedFeatures()
...
func (s *SqlStore) initConnection() {

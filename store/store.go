...
type TeamStore interface {
	...
	GetMember(teamId string, schemeId *string, userId string) (*model.TeamMember, error)
	GetMembers(teamId string, schemeId *string, offset int, limit int, teamMembersGetOptions *model.TeamMembersGetOptions) ([]*model.TeamMember, error)
	GetMembersByIds(teamId string, schemeId *string, userIds []string, restrictions *model.ViewUsersRestrictions) ([]*model.TeamMember, error)
...
type ChannelStore interface {
	...
	GetMembers(channelId string, teamSchemeId *string, channelSchemeId *string, offset, limit int) (*model.ChannelMembers, error)
	GetMember(channelId string, teamSchemeId *string, channelSchemeId *string, userId string) (*model.ChannelMember, error)

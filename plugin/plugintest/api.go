...
import (
	...
	actions "github.com/mattermost/mattermost-server/v6/services/actions"
	...
	systembus "github.com/mattermost/mattermost-server/v6/services/systembus"
)
...
// RegisterAction provides a mock function with given fields: actionDefinition
func (_m *API) RegisterAction(actionDefinition *actions.ActionDefinition) error {
	ret := _m.Called(actionDefinition)

	var r0 error
	if rf, ok := ret.Get(0).(func(*actions.ActionDefinition) error); ok {
		r0 = rf(actionDefinition)
	} else {
		r0 = ret.Error(0)
	}
...
// RegisterSystembusEvent provides a mock function with given fields: eventDefinition
func (_m *API) RegisterSystembusEvent(eventDefinition *systembus.EventDefinition) error {
	ret := _m.Called(eventDefinition)

	var r0 error
	if rf, ok := ret.Get(0).(func(*systembus.EventDefinition) error); ok {
		r0 = rf(eventDefinition)
	} else {
		r0 = ret.Error(0)
	}
...
// SendSystembusEvent provides a mock function with given fields: event
func (_m *API) SendSystembusEvent(event *systembus.Event) error {
	ret := _m.Called(event)

	var r0 error
	if rf, ok := ret.Get(0).(func(*systembus.Event) error); ok {
		r0 = rf(event)
	} else {
		r0 = ret.Error(0)
	}
